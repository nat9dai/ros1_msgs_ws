...
"""autogenerated by genpy from px4_msgs/VehicleCommand.msg. Do not edit."""
import codecs
import sys
...
class VehicleCommand(genpy.Message):
  _md5sum = "25a7338a064173aee4c96484689324e3"
  _type = "px4_msgs/VehicleCommand"
...
"""
  ...
  __slots__ = ['timestamp','param1','param2','param3','param4','param5','param6','param7','command','target_system','target_component','source_system','source_component','confirmation','from_external']
  _slot_types = ['uint64','float32','float32','float32','float32','float64','float64','float32','uint32','uint8','uint8','uint8','uint8','uint8','bool']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       timestamp,param1,param2,param3,param4,param5,param6,param7,command,target_system,target_component,source_system,source_component,confirmation,from_external
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_Q4f2dfI6B().pack(_x.timestamp, _x.param1, _x.param2, _x.param3, _x.param4, _x.param5, _x.param6, _x.param7, _x.command, _x.target_system, _x.target_component, _x.source_system, _x.source_component, _x.confirmation, _x.from_external))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.timestamp, _x.param1, _x.param2, _x.param3, _x.param4, _x.param5, _x.param6, _x.param7, _x.command, _x.target_system, _x.target_component, _x.source_system, _x.source_component, _x.confirmation, _x.from_external,) = _get_struct_Q4f2dfI6B().unpack(str[start:end])
...
def _get_struct_I():
    global _struct_I
    return _struct_I
_struct_Q4f2dfI6B = None
def _get_struct_Q4f2dfI6B():
    global _struct_Q4f2dfI6B
    if _struct_Q4f2dfI6B is None:
        _struct_Q4f2dfI6B = struct.Struct("<Q4f2dfI6B")
    return _struct_Q4f2dfI6B
