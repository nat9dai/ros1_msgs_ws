...
(cl:defclass <SensorGps> (roslisp-msg-protocol:ros-message)
  ((timestamp
   ...
   (automatic_gain_control
    :reader automatic_gain_control
    :initarg :automatic_gain_control
    :type cl:fixnum
    :initform 0)
   (jamming_indicator
...
(cl:defmethod cl:initialize-instance :after ((m <SensorGps>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SensorGps)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name px4_msgs-msg:<SensorGps> is deprecated: use px4_msgs-msg:SensorGps instead.")))
...
(cl:defmethod device_id-val ((m <SensorGps>))
...
(cl:defmethod alt-val ((m <SensorGps>))
...
(cl:defmethod alt_ellipsoid-val ((m <SensorGps>))
...
(cl:defmethod s_variance_m_s-val ((m <SensorGps>))
...
(cl:defmethod c_variance_rad-val ((m <SensorGps>))
...
(cl:defmethod fix_type-val ((m <SensorGps>))
...
(cl:defmethod eph-val ((m <SensorGps>))
...
(cl:defmethod epv-val ((m <SensorGps>))
...
(cl:defmethod hdop-val ((m <SensorGps>))
...
(cl:defmethod vdop-val ((m <SensorGps>))
...
(cl:defmethod noise_per_ms-val ((m <SensorGps>))
...
(cl:ensure-generic-function 'automatic_gain_control-val :lambda-list '(m))
(cl:defmethod automatic_gain_control-val ((m <SensorGps>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader px4_msgs-msg:automatic_gain_control-val is deprecated.  Use px4_msgs-msg:automatic_gain_control instead.")
  (automatic_gain_control m))

(cl:ensure-generic-function 'jamming_indicator-val :lambda-list '(m))
(cl:defmethod jamming_indicator-val ((m <SensorGps>))
...
(cl:defmethod jamming_state-val ((m <SensorGps>))
...
(cl:defmethod vel_m_s-val ((m <SensorGps>))
...
(cl:defmethod vel_n_m_s-val ((m <SensorGps>))
...
(cl:defmethod vel_e_m_s-val ((m <SensorGps>))
...
(cl:defmethod vel_d_m_s-val ((m <SensorGps>))
...
(cl:defmethod cog_rad-val ((m <SensorGps>))
...
(cl:defmethod vel_ned_valid-val ((m <SensorGps>))
...
(cl:defmethod timestamp_time_relative-val ((m <SensorGps>))
...
(cl:defmethod time_utc_usec-val ((m <SensorGps>))
...
(cl:defmethod satellites_used-val ((m <SensorGps>))
...
(cl:defmethod heading_offset-val ((m <SensorGps>))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <SensorGps>) ostream)
  ...
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'automatic_gain_control)) ostream)
  (cl:write-byte (cl:ldb (cl:byte 8 8) (cl:slot-value msg 'automatic_gain_control)) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <SensorGps>) istream)
  "Deserializes a message object of type '<SensorGps>"
    ...
    (cl:setf (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'automatic_gain_control)) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 8) (cl:slot-value msg 'automatic_gain_control)) (cl:read-byte istream))
    (cl:let ((unsigned 0))
      (cl:setf (cl:ldb (cl:byte 8 0) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) unsigned) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<SensorGps>)))
  ...
  "5421ee2ce1b6f70057a786f5f6083d61")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'SensorGps)))
  "Returns md5sum for a message object of type 'SensorGps"
  "5421ee2ce1b6f70057a786f5f6083d61")
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <SensorGps>))
  ...
  (cl:list 'SensorGps
    ...
    (cl:cons ':automatic_gain_control (automatic_gain_control msg))
