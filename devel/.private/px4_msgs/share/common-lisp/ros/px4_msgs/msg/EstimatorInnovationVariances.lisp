...
;//! \htmlinclude EstimatorInnovationVariances.msg.html

(cl:defclass <EstimatorInnovationVariances> (roslisp-msg-protocol:ros-message)
  ((timestamp
    :reader timestamp
    :initarg :timestamp
    :type cl:integer
...
(cl:defclass EstimatorInnovationVariances (<EstimatorInnovationVariances>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <EstimatorInnovationVariances>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'EstimatorInnovationVariances)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name px4_msgs-msg:<EstimatorInnovationVariances> is deprecated: use px4_msgs-msg:EstimatorInnovationVariances instead.")))

(cl:ensure-generic-function 'timestamp-val :lambda-list '(m))
(cl:defmethod timestamp-val ((m <EstimatorInnovationVariances>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader px4_msgs-msg:timestamp-val is deprecated.  Use px4_msgs-msg:timestamp instead.")
  (timestamp m))

(cl:ensure-generic-function 'timestamp_sample-val :lambda-list '(m))
(cl:defmethod timestamp_sample-val ((m <EstimatorInnovationVariances>))
...
(cl:defmethod gps_hvel-val ((m <EstimatorInnovationVariances>))
...
(cl:defmethod gps_vvel-val ((m <EstimatorInnovationVariances>))
...
(cl:defmethod gps_hpos-val ((m <EstimatorInnovationVariances>))
...
(cl:defmethod gps_vpos-val ((m <EstimatorInnovationVariances>))
...
(cl:defmethod ev_hvel-val ((m <EstimatorInnovationVariances>))
...
(cl:defmethod ev_vvel-val ((m <EstimatorInnovationVariances>))
...
(cl:defmethod ev_hpos-val ((m <EstimatorInnovationVariances>))
...
(cl:defmethod ev_vpos-val ((m <EstimatorInnovationVariances>))
...
(cl:defmethod rng_vpos-val ((m <EstimatorInnovationVariances>))
...
(cl:defmethod baro_vpos-val ((m <EstimatorInnovationVariances>))
...
(cl:defmethod aux_hvel-val ((m <EstimatorInnovationVariances>))
...
(cl:defmethod aux_vvel-val ((m <EstimatorInnovationVariances>))
...
(cl:defmethod flow-val ((m <EstimatorInnovationVariances>))
...
(cl:defmethod heading-val ((m <EstimatorInnovationVariances>))
...
(cl:defmethod mag_field-val ((m <EstimatorInnovationVariances>))
...
(cl:defmethod drag-val ((m <EstimatorInnovationVariances>))
...
(cl:defmethod airspeed-val ((m <EstimatorInnovationVariances>))
...
(cl:defmethod beta-val ((m <EstimatorInnovationVariances>))
...
(cl:defmethod hagl-val ((m <EstimatorInnovationVariances>))
  ...
  (hagl m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <EstimatorInnovationVariances>) ostream)
  "Serializes a message object of type '<EstimatorInnovationVariances>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <EstimatorInnovationVariances>) istream)
  "Deserializes a message object of type '<EstimatorInnovationVariances>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<EstimatorInnovationVariances>)))
  "Returns string type for a message object of type '<EstimatorInnovationVariances>"
  "px4_msgs/EstimatorInnovationVariances")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'EstimatorInnovationVariances)))
  "Returns string type for a message object of type 'EstimatorInnovationVariances"
  "px4_msgs/EstimatorInnovationVariances")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<EstimatorInnovationVariances>)))
  "Returns md5sum for a message object of type '<EstimatorInnovationVariances>"
  "6b9b2ca46042fb55c24b069a381dbf48")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'EstimatorInnovationVariances)))
  "Returns md5sum for a message object of type 'EstimatorInnovationVariances"
  "6b9b2ca46042fb55c24b069a381dbf48")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<EstimatorInnovationVariances>)))
  "Returns full string definition for message of type '<EstimatorInnovationVariances>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'EstimatorInnovationVariances)))
  "Returns full string definition for message of type 'EstimatorInnovationVariances"
  (cl:format cl:nil "uint64 timestamp		# time since system start (microseconds)~%uint64 timestamp_sample         # the timestamp of the raw data (microseconds)~%~%# GPS~%float32[2] gps_hvel	# horizontal GPS velocity innovation (m/sec) and innovation variance ((m/sec)**2)~%float32    gps_vvel	# vertical GPS velocity innovation (m/sec) and innovation variance ((m/sec)**2)~%float32[2] gps_hpos	# horizontal GPS position innovation (m) and innovation variance (m**2)~%float32    gps_vpos	# vertical GPS position innovation (m) and innovation variance (m**2)~%~%# External Vision~%float32[2] ev_hvel	# horizontal external vision velocity innovation (m/sec) and innovation variance ((m/sec)**2)~%float32    ev_vvel	# vertical external vision velocity innovation (m/sec) and innovation variance ((m/sec)**2)~%float32[2] ev_hpos	# horizontal external vision position innovation (m) and innovation variance (m**2)~%float32    ev_vpos	# vertical external vision position innovation (m) and innovation variance (m**2)~%~%# Height sensors~%float32 rng_vpos	# range sensor height innovation (m) and innovation variance (m**2)~%float32 baro_vpos	# barometer height innovation (m) and innovation variance (m**2)~%~%# Auxiliary velocity~%float32[2] aux_hvel	# horizontal auxiliar velocity innovation from landing target measurement (m/sec) and innovation variance ((m/sec)**2)~%float32    aux_vvel	# vertical auxiliar velocity innovation from landing target measurement (m/sec) and innovation variance ((m/sec)**2)~%~%# Optical flow~%float32[2] flow		# flow innvoation (rad/sec) and innovation variance ((rad/sec)**2)~%~%# Various~%float32 heading		# heading innovation (rad) and innovation variance (rad**2)~%float32[3] mag_field	# earth magnetic field innovation (Gauss) and innovation variance (Gauss**2)~%float32[2] drag		# drag specific force innovation (m/sec**2) and innovation variance ((m/sec)**2)~%float32 airspeed	# airspeed innovation (m/sec) and innovation variance ((m/sec)**2)~%float32 beta		# synthetic sideslip innovation (rad) and innovation variance (rad**2)~%float32 hagl		# height of ground innovation (m) and innovation variance (m**2)~%~%# The innovation test ratios are scalar values. In case the field is a vector,~%# the test ratio will be put in the first component of the vector.~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <EstimatorInnovationVariances>))
  (cl:+ 0
     8
     8
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <EstimatorInnovationVariances>))
  "Converts a ROS message object to a list"
  (cl:list 'EstimatorInnovationVariances
