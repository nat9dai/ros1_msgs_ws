...
;//! \htmlinclude SensorAccelFifo.msg.html

(cl:defclass <SensorAccelFifo> (roslisp-msg-protocol:ros-message)
  ((timestamp
    :reader timestamp
    :initarg :timestamp
    :type cl:integer
...
(cl:defclass SensorAccelFifo (<SensorAccelFifo>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <SensorAccelFifo>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'SensorAccelFifo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name px4_msgs-msg:<SensorAccelFifo> is deprecated: use px4_msgs-msg:SensorAccelFifo instead.")))

(cl:ensure-generic-function 'timestamp-val :lambda-list '(m))
(cl:defmethod timestamp-val ((m <SensorAccelFifo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader px4_msgs-msg:timestamp-val is deprecated.  Use px4_msgs-msg:timestamp instead.")
  (timestamp m))

(cl:ensure-generic-function 'timestamp_sample-val :lambda-list '(m))
(cl:defmethod timestamp_sample-val ((m <SensorAccelFifo>))
...
(cl:defmethod device_id-val ((m <SensorAccelFifo>))
...
(cl:defmethod dt-val ((m <SensorAccelFifo>))
...
(cl:defmethod scale-val ((m <SensorAccelFifo>))
...
(cl:defmethod samples-val ((m <SensorAccelFifo>))
...
(cl:defmethod x-val ((m <SensorAccelFifo>))
...
(cl:defmethod y-val ((m <SensorAccelFifo>))
...
(cl:defmethod z-val ((m <SensorAccelFifo>))
  ...
  (z m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <SensorAccelFifo>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <SensorAccelFifo>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SensorAccelFifo>)))
  "Returns string type for a message object of type '<SensorAccelFifo>"
  "px4_msgs/SensorAccelFifo")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SensorAccelFifo)))
  "Returns string type for a message object of type 'SensorAccelFifo"
  "px4_msgs/SensorAccelFifo")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<SensorAccelFifo>)))
  "Returns md5sum for a message object of type '<SensorAccelFifo>"
  "505f9acef52b09e51d69102c714c9fbd")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'SensorAccelFifo)))
  "Returns md5sum for a message object of type 'SensorAccelFifo"
  "505f9acef52b09e51d69102c714c9fbd")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SensorAccelFifo>)))
  "Returns full string definition for message of type '<SensorAccelFifo>"
  (cl:format cl:nil "uint64 timestamp          # time since system start (microseconds)~%uint64 timestamp_sample~%~%uint32 device_id          # unique device ID for the sensor that does not change between power cycles~%~%float32 dt                # delta time between samples (microseconds)~%float32 scale~%~%uint8 samples             # number of valid samples~%~%int16[32] x               # acceleration in the FRD board frame X-axis in m/s^2~%int16[32] y               # acceleration in the FRD board frame Y-axis in m/s^2~%int16[32] z               # acceleration in the FRD board frame Z-axis in m/s^2~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SensorAccelFifo)))
  "Returns full string definition for message of type 'SensorAccelFifo"
  (cl:format cl:nil "uint64 timestamp          # time since system start (microseconds)~%uint64 timestamp_sample~%~%uint32 device_id          # unique device ID for the sensor that does not change between power cycles~%~%float32 dt                # delta time between samples (microseconds)~%float32 scale~%~%uint8 samples             # number of valid samples~%~%int16[32] x               # acceleration in the FRD board frame X-axis in m/s^2~%int16[32] y               # acceleration in the FRD board frame Y-axis in m/s^2~%int16[32] z               # acceleration in the FRD board frame Z-axis in m/s^2~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <SensorAccelFifo>))
  (cl:+ 0
     8
     8
     4
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <SensorAccelFifo>))
  "Converts a ROS message object to a list"
  (cl:list 'SensorAccelFifo
