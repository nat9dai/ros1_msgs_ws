...
;//! \htmlinclude EstimatorWind.msg.html

(cl:defclass <EstimatorWind> (roslisp-msg-protocol:ros-message)
  ((timestamp
    :reader timestamp
    :initarg :timestamp
    :type cl:integer
...
(cl:defclass EstimatorWind (<EstimatorWind>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <EstimatorWind>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'EstimatorWind)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name px4_msgs-msg:<EstimatorWind> is deprecated: use px4_msgs-msg:EstimatorWind instead.")))

(cl:ensure-generic-function 'timestamp-val :lambda-list '(m))
(cl:defmethod timestamp-val ((m <EstimatorWind>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader px4_msgs-msg:timestamp-val is deprecated.  Use px4_msgs-msg:timestamp instead.")
  (timestamp m))

(cl:ensure-generic-function 'timestamp_sample-val :lambda-list '(m))
(cl:defmethod timestamp_sample-val ((m <EstimatorWind>))
...
(cl:defmethod windspeed_north-val ((m <EstimatorWind>))
...
(cl:defmethod windspeed_east-val ((m <EstimatorWind>))
...
(cl:defmethod variance_north-val ((m <EstimatorWind>))
...
(cl:defmethod variance_east-val ((m <EstimatorWind>))
...
(cl:defmethod tas_innov-val ((m <EstimatorWind>))
...
(cl:defmethod tas_innov_var-val ((m <EstimatorWind>))
...
(cl:defmethod beta_innov-val ((m <EstimatorWind>))
...
(cl:defmethod beta_innov_var-val ((m <EstimatorWind>))
  ...
  (beta_innov_var m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <EstimatorWind>) ostream)
  "Serializes a message object of type '<EstimatorWind>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <EstimatorWind>) istream)
  "Deserializes a message object of type '<EstimatorWind>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<EstimatorWind>)))
  "Returns string type for a message object of type '<EstimatorWind>"
  "px4_msgs/EstimatorWind")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'EstimatorWind)))
  "Returns string type for a message object of type 'EstimatorWind"
  "px4_msgs/EstimatorWind")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<EstimatorWind>)))
  "Returns md5sum for a message object of type '<EstimatorWind>"
  "41437d02b61a509f848025324091afb6")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'EstimatorWind)))
  "Returns md5sum for a message object of type 'EstimatorWind"
  "41437d02b61a509f848025324091afb6")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<EstimatorWind>)))
  "Returns full string definition for message of type '<EstimatorWind>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'EstimatorWind)))
  "Returns full string definition for message of type 'EstimatorWind"
  (cl:format cl:nil "uint64 timestamp		# time since system start (microseconds)~%uint64 timestamp_sample         # the timestamp of the raw data (microseconds)~%~%float32 windspeed_north		# Wind component in north / X direction (m/sec)~%float32 windspeed_east		# Wind component in east / Y direction (m/sec)~%~%float32 variance_north		# Wind estimate error variance in north / X direction (m/sec)**2 - set to zero (no uncertainty) if not estimated~%float32 variance_east		# Wind estimate error variance in east / Y direction (m/sec)**2 - set to zero (no uncertainty) if not estimated~%~%float32 tas_innov 		# True airspeed innovation~%float32 tas_innov_var 		# True airspeed innovation variance~%~%float32 beta_innov 		# Sideslip measurement innovation~%float32 beta_innov_var 		# Sideslip measurement innovation variance~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <EstimatorWind>))
  (cl:+ 0
     8
     8
     4
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <EstimatorWind>))
  "Converts a ROS message object to a list"
  (cl:list 'EstimatorWind
