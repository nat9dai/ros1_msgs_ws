...
;//! \htmlinclude EstimatorAttitude.msg.html

(cl:defclass <EstimatorAttitude> (roslisp-msg-protocol:ros-message)
  ((timestamp
    :reader timestamp
    :initarg :timestamp
    :type cl:integer
...
(cl:defclass EstimatorAttitude (<EstimatorAttitude>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <EstimatorAttitude>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'EstimatorAttitude)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name px4_msgs-msg:<EstimatorAttitude> is deprecated: use px4_msgs-msg:EstimatorAttitude instead.")))

(cl:ensure-generic-function 'timestamp-val :lambda-list '(m))
(cl:defmethod timestamp-val ((m <EstimatorAttitude>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader px4_msgs-msg:timestamp-val is deprecated.  Use px4_msgs-msg:timestamp instead.")
  (timestamp m))

(cl:ensure-generic-function 'timestamp_sample-val :lambda-list '(m))
(cl:defmethod timestamp_sample-val ((m <EstimatorAttitude>))
...
(cl:defmethod q-val ((m <EstimatorAttitude>))
...
(cl:defmethod delta_q_reset-val ((m <EstimatorAttitude>))
...
(cl:defmethod quat_reset_counter-val ((m <EstimatorAttitude>))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <EstimatorAttitude>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <EstimatorAttitude>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<EstimatorAttitude>)))
  "Returns string type for a message object of type '<EstimatorAttitude>"
  "px4_msgs/EstimatorAttitude")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'EstimatorAttitude)))
  "Returns string type for a message object of type 'EstimatorAttitude"
  "px4_msgs/EstimatorAttitude")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<EstimatorAttitude>)))
  "Returns md5sum for a message object of type '<EstimatorAttitude>"
  "6deee58da52e839cdd31b307edb8e44c")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'EstimatorAttitude)))
  "Returns md5sum for a message object of type 'EstimatorAttitude"
  "6deee58da52e839cdd31b307edb8e44c")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<EstimatorAttitude>)))
  "Returns full string definition for message of type '<EstimatorAttitude>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'EstimatorAttitude)))
  "Returns full string definition for message of type 'EstimatorAttitude"
  (cl:format cl:nil "# This is similar to the mavlink message ATTITUDE_QUATERNION, but for onboard use~%~%uint64 timestamp		    # time since system start (microseconds)~%~%uint64 timestamp_sample     # the timestamp of the raw data (microseconds)~%~%float32[4] q			    # Quaternion rotation from the FRD body frame to the NED earth frame~%float32[4] delta_q_reset 	# Amount by which quaternion has changed during last reset~%uint8 quat_reset_counter	# Quaternion reset counter~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <EstimatorAttitude>))
  (cl:+ 0
     8
     8
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <EstimatorAttitude>))
  "Converts a ROS message object to a list"
  (cl:list 'EstimatorAttitude
