...
(cl:defmethod cl:initialize-instance :after ((m <ObstacleDistance>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ObstacleDistance)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name px4_msgs-msg:<ObstacleDistance> is deprecated: use px4_msgs-msg:ObstacleDistance instead.")))

(cl:ensure-generic-function 'timestamp-val :lambda-list '(m))
(cl:defmethod timestamp-val ((m <ObstacleDistance>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader px4_msgs-msg:timestamp-val is deprecated.  Use px4_msgs-msg:timestamp instead.")
  (timestamp m))

(cl:ensure-generic-function 'frame-val :lambda-list '(m))
(cl:defmethod frame-val ((m <ObstacleDistance>))
...
(cl:defmethod sensor_type-val ((m <ObstacleDistance>))
...
(cl:defmethod distances-val ((m <ObstacleDistance>))
...
(cl:defmethod increment-val ((m <ObstacleDistance>))
...
(cl:defmethod min_distance-val ((m <ObstacleDistance>))
...
(cl:defmethod max_distance-val ((m <ObstacleDistance>))
...
(cl:defmethod angle_offset-val ((m <ObstacleDistance>))
  ...
  (angle_offset m))
(cl:defmethod roslisp-msg-protocol:symbol-codes ((msg-type (cl:eql '<ObstacleDistance>)))
    "Constants for message type '<ObstacleDistance>"
  '((:MAV_FRAME_GLOBAL . 0)
