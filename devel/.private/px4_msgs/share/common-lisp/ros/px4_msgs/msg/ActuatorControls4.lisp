...
;//! \htmlinclude ActuatorControls4.msg.html

(cl:defclass <ActuatorControls4> (roslisp-msg-protocol:ros-message)
  ((timestamp
    :reader timestamp
    :initarg :timestamp
    :type cl:integer
...
(cl:defclass ActuatorControls4 (<ActuatorControls4>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <ActuatorControls4>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'ActuatorControls4)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name px4_msgs-msg:<ActuatorControls4> is deprecated: use px4_msgs-msg:ActuatorControls4 instead.")))

(cl:ensure-generic-function 'timestamp-val :lambda-list '(m))
(cl:defmethod timestamp-val ((m <ActuatorControls4>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader px4_msgs-msg:timestamp-val is deprecated.  Use px4_msgs-msg:timestamp instead.")
  (timestamp m))

(cl:ensure-generic-function 'timestamp_sample-val :lambda-list '(m))
(cl:defmethod timestamp_sample-val ((m <ActuatorControls4>))
...
(cl:defmethod control-val ((m <ActuatorControls4>))
  ...
  (control m))
(cl:defmethod roslisp-msg-protocol:symbol-codes ((msg-type (cl:eql '<ActuatorControls4>)))
    "Constants for message type '<ActuatorControls4>"
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <ActuatorControls4>) ostream)
  "Serializes a message object of type '<ActuatorControls4>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ActuatorControls4>) istream)
  "Deserializes a message object of type '<ActuatorControls4>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ActuatorControls4>)))
  "Returns string type for a message object of type '<ActuatorControls4>"
  "px4_msgs/ActuatorControls4")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ActuatorControls4)))
  "Returns string type for a message object of type 'ActuatorControls4"
  "px4_msgs/ActuatorControls4")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ActuatorControls4>)))
  "Returns md5sum for a message object of type '<ActuatorControls4>"
  "b2e727b373981b888a45a87c1771aca3")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ActuatorControls4)))
  "Returns md5sum for a message object of type 'ActuatorControls4"
  "b2e727b373981b888a45a87c1771aca3")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ActuatorControls4>)))
  "Returns full string definition for message of type '<ActuatorControls4>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ActuatorControls4)))
  "Returns full string definition for message of type 'ActuatorControls4"
  (cl:format cl:nil "uint64 timestamp			# time since system start (microseconds)~%uint8 NUM_ACTUATOR_CONTROLS = 8~%uint8 NUM_ACTUATOR_CONTROL_GROUPS = 6~%uint8 INDEX_ROLL = 0~%uint8 INDEX_PITCH = 1~%uint8 INDEX_YAW = 2~%uint8 INDEX_THROTTLE = 3~%uint8 INDEX_FLAPS = 4~%uint8 INDEX_SPOILERS = 5~%uint8 INDEX_AIRBRAKES = 6~%uint8 INDEX_LANDING_GEAR = 7~%uint8 INDEX_GIMBAL_SHUTTER = 3~%uint8 INDEX_CAMERA_ZOOM = 4~%~%uint8 GROUP_INDEX_ATTITUDE = 0~%uint8 GROUP_INDEX_ATTITUDE_ALTERNATE = 1~%uint8 GROUP_INDEX_GIMBAL = 2~%uint8 GROUP_INDEX_MANUAL_PASSTHROUGH = 3~%uint8 GROUP_INDEX_ALLOCATED_PART1 = 4~%uint8 GROUP_INDEX_ALLOCATED_PART2 = 5~%uint8 GROUP_INDEX_PAYLOAD = 6~%~%uint64 timestamp_sample	    # the timestamp the data this control response is based on was sampled~%float32[8] control~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <ActuatorControls4>))
  (cl:+ 0
     8
     8
     0 (cl:reduce #'cl:+ (cl:slot-value msg 'control) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ 4)))
))
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <ActuatorControls4>))
  "Converts a ROS message object to a list"
  (cl:list 'ActuatorControls4
