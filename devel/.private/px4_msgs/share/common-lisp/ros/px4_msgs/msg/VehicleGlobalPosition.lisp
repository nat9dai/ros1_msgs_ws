...
;//! \htmlinclude VehicleGlobalPosition.msg.html

(cl:defclass <VehicleGlobalPosition> (roslisp-msg-protocol:ros-message)
  ((timestamp
    :reader timestamp
    :initarg :timestamp
    :type cl:integer
...
(cl:defclass VehicleGlobalPosition (<VehicleGlobalPosition>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <VehicleGlobalPosition>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'VehicleGlobalPosition)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name px4_msgs-msg:<VehicleGlobalPosition> is deprecated: use px4_msgs-msg:VehicleGlobalPosition instead.")))

(cl:ensure-generic-function 'timestamp-val :lambda-list '(m))
(cl:defmethod timestamp-val ((m <VehicleGlobalPosition>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader px4_msgs-msg:timestamp-val is deprecated.  Use px4_msgs-msg:timestamp instead.")
  (timestamp m))

(cl:ensure-generic-function 'timestamp_sample-val :lambda-list '(m))
(cl:defmethod timestamp_sample-val ((m <VehicleGlobalPosition>))
...
(cl:defmethod lat-val ((m <VehicleGlobalPosition>))
...
(cl:defmethod lon-val ((m <VehicleGlobalPosition>))
...
(cl:defmethod alt-val ((m <VehicleGlobalPosition>))
...
(cl:defmethod alt_ellipsoid-val ((m <VehicleGlobalPosition>))
...
(cl:defmethod delta_alt-val ((m <VehicleGlobalPosition>))
...
(cl:defmethod lat_lon_reset_counter-val ((m <VehicleGlobalPosition>))
...
(cl:defmethod alt_reset_counter-val ((m <VehicleGlobalPosition>))
...
(cl:defmethod eph-val ((m <VehicleGlobalPosition>))
...
(cl:defmethod epv-val ((m <VehicleGlobalPosition>))
...
(cl:defmethod terrain_alt-val ((m <VehicleGlobalPosition>))
...
(cl:defmethod terrain_alt_valid-val ((m <VehicleGlobalPosition>))
...
(cl:defmethod dead_reckoning-val ((m <VehicleGlobalPosition>))
  ...
  (dead_reckoning m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <VehicleGlobalPosition>) ostream)
  "Serializes a message object of type '<VehicleGlobalPosition>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <VehicleGlobalPosition>) istream)
  "Deserializes a message object of type '<VehicleGlobalPosition>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<VehicleGlobalPosition>)))
  "Returns string type for a message object of type '<VehicleGlobalPosition>"
  "px4_msgs/VehicleGlobalPosition")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'VehicleGlobalPosition)))
  "Returns string type for a message object of type 'VehicleGlobalPosition"
  "px4_msgs/VehicleGlobalPosition")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<VehicleGlobalPosition>)))
  "Returns md5sum for a message object of type '<VehicleGlobalPosition>"
  "e8295c6442b5704cbc0f13914d1270f4")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'VehicleGlobalPosition)))
  "Returns md5sum for a message object of type 'VehicleGlobalPosition"
  "e8295c6442b5704cbc0f13914d1270f4")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<VehicleGlobalPosition>)))
  "Returns full string definition for message of type '<VehicleGlobalPosition>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'VehicleGlobalPosition)))
  "Returns full string definition for message of type 'VehicleGlobalPosition"
  (cl:format cl:nil "# Fused global position in WGS84.~%# This struct contains global position estimation. It is not the raw GPS~%# measurement (@see vehicle_gps_position). This topic is usually published by the position~%# estimator, which will take more sources of information into account than just GPS,~%# e.g. control inputs of the vehicle in a Kalman-filter implementation.~%#~%~%uint64 timestamp		# time since system start (microseconds)~%uint64 timestamp_sample         # the timestamp of the raw data (microseconds)~%~%float64 lat			# Latitude, (degrees)~%float64 lon			# Longitude, (degrees)~%float32 alt			# Altitude AMSL, (meters)~%float32 alt_ellipsoid		# Altitude above ellipsoid, (meters)~%~%float32 delta_alt 	# Reset delta for altitude~%uint8 lat_lon_reset_counter	# Counter for reset events on horizontal position coordinates~%uint8 alt_reset_counter 	# Counter for reset events on altitude~%~%float32 eph			# Standard deviation of horizontal position error, (metres)~%float32 epv			# Standard deviation of vertical position error, (metres)~%~%float32 terrain_alt		# Terrain altitude WGS84, (metres)~%bool terrain_alt_valid		# Terrain altitude estimate is valid~%~%bool dead_reckoning		# True if this position is estimated through dead-reckoning~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <VehicleGlobalPosition>))
  (cl:+ 0
     8
     8
     8
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <VehicleGlobalPosition>))
  "Converts a ROS message object to a list"
  (cl:list 'VehicleGlobalPosition
