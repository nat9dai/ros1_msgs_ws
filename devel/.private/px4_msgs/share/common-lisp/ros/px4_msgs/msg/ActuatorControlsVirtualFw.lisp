...
;//! \htmlinclude ActuatorControlsVirtualFw.msg.html

(cl:defclass <ActuatorControlsVirtualFw> (roslisp-msg-protocol:ros-message)
  ((timestamp
    :reader timestamp
    :initarg :timestamp
    :type cl:integer
...
(cl:defclass ActuatorControlsVirtualFw (<ActuatorControlsVirtualFw>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <ActuatorControlsVirtualFw>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'ActuatorControlsVirtualFw)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name px4_msgs-msg:<ActuatorControlsVirtualFw> is deprecated: use px4_msgs-msg:ActuatorControlsVirtualFw instead.")))

(cl:ensure-generic-function 'timestamp-val :lambda-list '(m))
(cl:defmethod timestamp-val ((m <ActuatorControlsVirtualFw>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader px4_msgs-msg:timestamp-val is deprecated.  Use px4_msgs-msg:timestamp instead.")
  (timestamp m))

(cl:ensure-generic-function 'timestamp_sample-val :lambda-list '(m))
(cl:defmethod timestamp_sample-val ((m <ActuatorControlsVirtualFw>))
...
(cl:defmethod control-val ((m <ActuatorControlsVirtualFw>))
  ...
  (control m))
(cl:defmethod roslisp-msg-protocol:symbol-codes ((msg-type (cl:eql '<ActuatorControlsVirtualFw>)))
    "Constants for message type '<ActuatorControlsVirtualFw>"
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <ActuatorControlsVirtualFw>) ostream)
  "Serializes a message object of type '<ActuatorControlsVirtualFw>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ActuatorControlsVirtualFw>) istream)
  "Deserializes a message object of type '<ActuatorControlsVirtualFw>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ActuatorControlsVirtualFw>)))
  "Returns string type for a message object of type '<ActuatorControlsVirtualFw>"
  "px4_msgs/ActuatorControlsVirtualFw")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ActuatorControlsVirtualFw)))
  "Returns string type for a message object of type 'ActuatorControlsVirtualFw"
  "px4_msgs/ActuatorControlsVirtualFw")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ActuatorControlsVirtualFw>)))
  "Returns md5sum for a message object of type '<ActuatorControlsVirtualFw>"
  "b2e727b373981b888a45a87c1771aca3")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ActuatorControlsVirtualFw)))
  "Returns md5sum for a message object of type 'ActuatorControlsVirtualFw"
  "b2e727b373981b888a45a87c1771aca3")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ActuatorControlsVirtualFw>)))
  "Returns full string definition for message of type '<ActuatorControlsVirtualFw>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ActuatorControlsVirtualFw)))
  "Returns full string definition for message of type 'ActuatorControlsVirtualFw"
  (cl:format cl:nil "uint64 timestamp			# time since system start (microseconds)~%uint8 NUM_ACTUATOR_CONTROLS = 8~%uint8 NUM_ACTUATOR_CONTROL_GROUPS = 6~%uint8 INDEX_ROLL = 0~%uint8 INDEX_PITCH = 1~%uint8 INDEX_YAW = 2~%uint8 INDEX_THROTTLE = 3~%uint8 INDEX_FLAPS = 4~%uint8 INDEX_SPOILERS = 5~%uint8 INDEX_AIRBRAKES = 6~%uint8 INDEX_LANDING_GEAR = 7~%uint8 INDEX_GIMBAL_SHUTTER = 3~%uint8 INDEX_CAMERA_ZOOM = 4~%~%uint8 GROUP_INDEX_ATTITUDE = 0~%uint8 GROUP_INDEX_ATTITUDE_ALTERNATE = 1~%uint8 GROUP_INDEX_GIMBAL = 2~%uint8 GROUP_INDEX_MANUAL_PASSTHROUGH = 3~%uint8 GROUP_INDEX_ALLOCATED_PART1 = 4~%uint8 GROUP_INDEX_ALLOCATED_PART2 = 5~%uint8 GROUP_INDEX_PAYLOAD = 6~%~%uint64 timestamp_sample	    # the timestamp the data this control response is based on was sampled~%float32[8] control~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <ActuatorControlsVirtualFw>))
  (cl:+ 0
     8
     8
     0 (cl:reduce #'cl:+ (cl:slot-value msg 'control) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ 4)))
))
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <ActuatorControlsVirtualFw>))
  "Converts a ROS message object to a list"
  (cl:list 'ActuatorControlsVirtualFw
