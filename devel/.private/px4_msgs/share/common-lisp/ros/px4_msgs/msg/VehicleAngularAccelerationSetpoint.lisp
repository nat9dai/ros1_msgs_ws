...
;//! \htmlinclude VehicleAngularAccelerationSetpoint.msg.html

(cl:defclass <VehicleAngularAccelerationSetpoint> (roslisp-msg-protocol:ros-message)
  ((timestamp
    :reader timestamp
    :initarg :timestamp
    :type cl:integer
...
(cl:defclass VehicleAngularAccelerationSetpoint (<VehicleAngularAccelerationSetpoint>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <VehicleAngularAccelerationSetpoint>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'VehicleAngularAccelerationSetpoint)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name px4_msgs-msg:<VehicleAngularAccelerationSetpoint> is deprecated: use px4_msgs-msg:VehicleAngularAccelerationSetpoint instead.")))

(cl:ensure-generic-function 'timestamp-val :lambda-list '(m))
(cl:defmethod timestamp-val ((m <VehicleAngularAccelerationSetpoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader px4_msgs-msg:timestamp-val is deprecated.  Use px4_msgs-msg:timestamp instead.")
  (timestamp m))

(cl:ensure-generic-function 'timestamp_sample-val :lambda-list '(m))
(cl:defmethod timestamp_sample-val ((m <VehicleAngularAccelerationSetpoint>))
...
(cl:defmethod xyz-val ((m <VehicleAngularAccelerationSetpoint>))
  ...
  (xyz m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <VehicleAngularAccelerationSetpoint>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <VehicleAngularAccelerationSetpoint>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<VehicleAngularAccelerationSetpoint>)))
  "Returns string type for a message object of type '<VehicleAngularAccelerationSetpoint>"
  "px4_msgs/VehicleAngularAccelerationSetpoint")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'VehicleAngularAccelerationSetpoint)))
  "Returns string type for a message object of type 'VehicleAngularAccelerationSetpoint"
  "px4_msgs/VehicleAngularAccelerationSetpoint")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<VehicleAngularAccelerationSetpoint>)))
  "Returns md5sum for a message object of type '<VehicleAngularAccelerationSetpoint>"
  "88b7d1ed56fc632d088f26d07cc23fe6")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'VehicleAngularAccelerationSetpoint)))
  "Returns md5sum for a message object of type 'VehicleAngularAccelerationSetpoint"
  "88b7d1ed56fc632d088f26d07cc23fe6")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<VehicleAngularAccelerationSetpoint>)))
  "Returns full string definition for message of type '<VehicleAngularAccelerationSetpoint>"
  (cl:format cl:nil "~%uint64 timestamp         # time since system start (microseconds)~%uint64 timestamp_sample  # timestamp of the data sample on which this message is based (microseconds)~%~%float32[3] xyz           # angular acceleration about X, Y, Z body axis in rad/s^2~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'VehicleAngularAccelerationSetpoint)))
  "Returns full string definition for message of type 'VehicleAngularAccelerationSetpoint"
  (cl:format cl:nil "~%uint64 timestamp         # time since system start (microseconds)~%uint64 timestamp_sample  # timestamp of the data sample on which this message is based (microseconds)~%~%float32[3] xyz           # angular acceleration about X, Y, Z body axis in rad/s^2~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <VehicleAngularAccelerationSetpoint>))
  (cl:+ 0
     8
     8
     0 (cl:reduce #'cl:+ (cl:slot-value msg 'xyz) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ 4)))
))
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <VehicleAngularAccelerationSetpoint>))
  "Converts a ROS message object to a list"
  (cl:list 'VehicleAngularAccelerationSetpoint
