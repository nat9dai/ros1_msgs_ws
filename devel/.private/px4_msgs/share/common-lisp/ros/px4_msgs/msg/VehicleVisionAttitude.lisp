...
;//! \htmlinclude VehicleVisionAttitude.msg.html

(cl:defclass <VehicleVisionAttitude> (roslisp-msg-protocol:ros-message)
  ((timestamp
    :reader timestamp
    :initarg :timestamp
    :type cl:integer
...
(cl:defclass VehicleVisionAttitude (<VehicleVisionAttitude>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <VehicleVisionAttitude>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'VehicleVisionAttitude)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name px4_msgs-msg:<VehicleVisionAttitude> is deprecated: use px4_msgs-msg:VehicleVisionAttitude instead.")))

(cl:ensure-generic-function 'timestamp-val :lambda-list '(m))
(cl:defmethod timestamp-val ((m <VehicleVisionAttitude>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader px4_msgs-msg:timestamp-val is deprecated.  Use px4_msgs-msg:timestamp instead.")
  (timestamp m))

(cl:ensure-generic-function 'timestamp_sample-val :lambda-list '(m))
(cl:defmethod timestamp_sample-val ((m <VehicleVisionAttitude>))
...
(cl:defmethod q-val ((m <VehicleVisionAttitude>))
...
(cl:defmethod delta_q_reset-val ((m <VehicleVisionAttitude>))
...
(cl:defmethod quat_reset_counter-val ((m <VehicleVisionAttitude>))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <VehicleVisionAttitude>) ostream)
  "Serializes a message object of type '<VehicleVisionAttitude>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <VehicleVisionAttitude>) istream)
  "Deserializes a message object of type '<VehicleVisionAttitude>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<VehicleVisionAttitude>)))
  "Returns string type for a message object of type '<VehicleVisionAttitude>"
  "px4_msgs/VehicleVisionAttitude")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'VehicleVisionAttitude)))
  "Returns string type for a message object of type 'VehicleVisionAttitude"
  "px4_msgs/VehicleVisionAttitude")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<VehicleVisionAttitude>)))
  "Returns md5sum for a message object of type '<VehicleVisionAttitude>"
  "6deee58da52e839cdd31b307edb8e44c")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'VehicleVisionAttitude)))
  "Returns md5sum for a message object of type 'VehicleVisionAttitude"
  "6deee58da52e839cdd31b307edb8e44c")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<VehicleVisionAttitude>)))
  "Returns full string definition for message of type '<VehicleVisionAttitude>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'VehicleVisionAttitude)))
  "Returns full string definition for message of type 'VehicleVisionAttitude"
  (cl:format cl:nil "# This is similar to the mavlink message ATTITUDE_QUATERNION, but for onboard use~%~%uint64 timestamp		    # time since system start (microseconds)~%~%uint64 timestamp_sample     # the timestamp of the raw data (microseconds)~%~%float32[4] q			    # Quaternion rotation from the FRD body frame to the NED earth frame~%float32[4] delta_q_reset 	# Amount by which quaternion has changed during last reset~%uint8 quat_reset_counter	# Quaternion reset counter~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <VehicleVisionAttitude>))
  (cl:+ 0
     8
     8
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <VehicleVisionAttitude>))
  "Converts a ROS message object to a list"
  (cl:list 'VehicleVisionAttitude
