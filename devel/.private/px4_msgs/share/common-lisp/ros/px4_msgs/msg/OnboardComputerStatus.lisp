...
(cl:defmethod cl:initialize-instance :after ((m <OnboardComputerStatus>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'OnboardComputerStatus)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name px4_msgs-msg:<OnboardComputerStatus> is deprecated: use px4_msgs-msg:OnboardComputerStatus instead.")))

(cl:ensure-generic-function 'timestamp-val :lambda-list '(m))
(cl:defmethod timestamp-val ((m <OnboardComputerStatus>))
...
(cl:defmethod uptime-val ((m <OnboardComputerStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader px4_msgs-msg:uptime-val is deprecated.  Use px4_msgs-msg:uptime instead.")
  (uptime m))
...
(cl:defmethod cpu_cores-val ((m <OnboardComputerStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader px4_msgs-msg:cpu_cores-val is deprecated.  Use px4_msgs-msg:cpu_cores instead.")
  (cpu_cores m))

(cl:ensure-generic-function 'cpu_combined-val :lambda-list '(m))
(cl:defmethod cpu_combined-val ((m <OnboardComputerStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader px4_msgs-msg:cpu_combined-val is deprecated.  Use px4_msgs-msg:cpu_combined instead.")
  (cpu_combined m))

(cl:ensure-generic-function 'gpu_cores-val :lambda-list '(m))
(cl:defmethod gpu_cores-val ((m <OnboardComputerStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader px4_msgs-msg:gpu_cores-val is deprecated.  Use px4_msgs-msg:gpu_cores instead.")
  (gpu_cores m))

(cl:ensure-generic-function 'gpu_combined-val :lambda-list '(m))
(cl:defmethod gpu_combined-val ((m <OnboardComputerStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader px4_msgs-msg:gpu_combined-val is deprecated.  Use px4_msgs-msg:gpu_combined instead.")
  (gpu_combined m))

(cl:ensure-generic-function 'temperature_board-val :lambda-list '(m))
(cl:defmethod temperature_board-val ((m <OnboardComputerStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader px4_msgs-msg:temperature_board-val is deprecated.  Use px4_msgs-msg:temperature_board instead.")
  (temperature_board m))

(cl:ensure-generic-function 'temperature_core-val :lambda-list '(m))
(cl:defmethod temperature_core-val ((m <OnboardComputerStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader px4_msgs-msg:temperature_core-val is deprecated.  Use px4_msgs-msg:temperature_core instead.")
  (temperature_core m))

(cl:ensure-generic-function 'fan_speed-val :lambda-list '(m))
(cl:defmethod fan_speed-val ((m <OnboardComputerStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader px4_msgs-msg:fan_speed-val is deprecated.  Use px4_msgs-msg:fan_speed instead.")
  (fan_speed m))
...
(cl:defmethod ram_total-val ((m <OnboardComputerStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader px4_msgs-msg:ram_total-val is deprecated.  Use px4_msgs-msg:ram_total instead.")
  (ram_total m))

(cl:ensure-generic-function 'storage_type-val :lambda-list '(m))
(cl:defmethod storage_type-val ((m <OnboardComputerStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader px4_msgs-msg:storage_type-val is deprecated.  Use px4_msgs-msg:storage_type instead.")
  (storage_type m))

(cl:ensure-generic-function 'storage_usage-val :lambda-list '(m))
(cl:defmethod storage_usage-val ((m <OnboardComputerStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader px4_msgs-msg:storage_usage-val is deprecated.  Use px4_msgs-msg:storage_usage instead.")
  (storage_usage m))

(cl:ensure-generic-function 'storage_total-val :lambda-list '(m))
(cl:defmethod storage_total-val ((m <OnboardComputerStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader px4_msgs-msg:storage_total-val is deprecated.  Use px4_msgs-msg:storage_total instead.")
  (storage_total m))

(cl:ensure-generic-function 'link_type-val :lambda-list '(m))
(cl:defmethod link_type-val ((m <OnboardComputerStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader px4_msgs-msg:link_type-val is deprecated.  Use px4_msgs-msg:link_type instead.")
  (link_type m))

(cl:ensure-generic-function 'link_tx_rate-val :lambda-list '(m))
(cl:defmethod link_tx_rate-val ((m <OnboardComputerStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader px4_msgs-msg:link_tx_rate-val is deprecated.  Use px4_msgs-msg:link_tx_rate instead.")
  (link_tx_rate m))

(cl:ensure-generic-function 'link_rx_rate-val :lambda-list '(m))
(cl:defmethod link_rx_rate-val ((m <OnboardComputerStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader px4_msgs-msg:link_rx_rate-val is deprecated.  Use px4_msgs-msg:link_rx_rate instead.")
  (link_rx_rate m))

(cl:ensure-generic-function 'link_tx_max-val :lambda-list '(m))
(cl:defmethod link_tx_max-val ((m <OnboardComputerStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader px4_msgs-msg:link_tx_max-val is deprecated.  Use px4_msgs-msg:link_tx_max instead.")
  (link_tx_max m))

(cl:ensure-generic-function 'link_rx_max-val :lambda-list '(m))
(cl:defmethod link_rx_max-val ((m <OnboardComputerStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader px4_msgs-msg:link_rx_max-val is deprecated.  Use px4_msgs-msg:link_rx_max instead.")
  (link_rx_max m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<OnboardComputerStatus>)))
  ...
  "px4_msgs/OnboardComputerStatus")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'OnboardComputerStatus)))
  "Returns string type for a message object of type 'OnboardComputerStatus"
  "px4_msgs/OnboardComputerStatus")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<OnboardComputerStatus>)))
  ...
  "3b4ac743052d13f33f3fc102ac7364ae")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'OnboardComputerStatus)))
  "Returns md5sum for a message object of type 'OnboardComputerStatus"
  "3b4ac743052d13f33f3fc102ac7364ae")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<OnboardComputerStatus>)))
  ...
  (cl:format cl:nil "# ONBOARD_COMPUTER_STATUS message data~%uint64 timestamp # [us] time since system start (microseconds)~%uint32 uptime	 # [ms] time since system boot of the companion (milliseconds)~%~%uint8 type	 # type of onboard computer 0: Mission computer primary, 1: Mission computer backup 1, 2: Mission computer backup 2, 3: Compute node, 4-5: Compute spares, 6-9: Payload computers.~%~%uint8[8] cpu_cores # CPU usage on the component in percent~%uint8[10] cpu_combined # Combined CPU usage as the last 10 slices of 100 MS~%uint8[4] gpu_cores # GPU usage on the component in percent~%uint8[10] gpu_combined # Combined GPU usage as the last 10 slices of 100 MS~%int8 temperature_board # [degC] Temperature of the board~%int8[8] temperature_core # [degC] Temperature of the CPU core~%int16[4] fan_speed # [rpm] Fan speeds~%uint32 ram_usage # [MB] Amount of used RAM on the component system~%uint32 ram_total # [MB] Total amount of RAM on the component system~%uint32[4] storage_type # Storage type: 0: HDD, 1: SSD, 2: EMMC, 3: SD card (non-removable), 4: SD card (removable)~%uint32[4] storage_usage # [MB] Amount of used storage space on the component system~%uint32[4] storage_total # [MB] Total amount of storage space on the component system~%uint32[6] link_type # [Kb/s] Link type: 0-9: UART, 10-19: Wired network, 20-29: Wifi, 30-39: Point-to-point proprietary, 40-49: Mesh proprietary~%uint32[6] link_tx_rate # [Kb/s] Network traffic from the component system~%uint32[6] link_rx_rate # [Kb/s] Network traffic to the component system~%uint32[6] link_tx_max # [Kb/s] Network capacity from the component system~%uint32[6] link_rx_max # [Kb/s] Network capacity to the component system~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'OnboardComputerStatus)))
  "Returns full string definition for message of type 'OnboardComputerStatus"
  (cl:format cl:nil "# ONBOARD_COMPUTER_STATUS message data~%uint64 timestamp # [us] time since system start (microseconds)~%uint32 uptime	 # [ms] time since system boot of the companion (milliseconds)~%~%uint8 type	 # type of onboard computer 0: Mission computer primary, 1: Mission computer backup 1, 2: Mission computer backup 2, 3: Compute node, 4-5: Compute spares, 6-9: Payload computers.~%~%uint8[8] cpu_cores # CPU usage on the component in percent~%uint8[10] cpu_combined # Combined CPU usage as the last 10 slices of 100 MS~%uint8[4] gpu_cores # GPU usage on the component in percent~%uint8[10] gpu_combined # Combined GPU usage as the last 10 slices of 100 MS~%int8 temperature_board # [degC] Temperature of the board~%int8[8] temperature_core # [degC] Temperature of the CPU core~%int16[4] fan_speed # [rpm] Fan speeds~%uint32 ram_usage # [MB] Amount of used RAM on the component system~%uint32 ram_total # [MB] Total amount of RAM on the component system~%uint32[4] storage_type # Storage type: 0: HDD, 1: SSD, 2: EMMC, 3: SD card (non-removable), 4: SD card (removable)~%uint32[4] storage_usage # [MB] Amount of used storage space on the component system~%uint32[4] storage_total # [MB] Total amount of storage space on the component system~%uint32[6] link_type # [Kb/s] Link type: 0-9: UART, 10-19: Wired network, 20-29: Wifi, 30-39: Point-to-point proprietary, 40-49: Mesh proprietary~%uint32[6] link_tx_rate # [Kb/s] Network traffic from the component system~%uint32[6] link_rx_rate # [Kb/s] Network traffic to the component system~%uint32[6] link_tx_max # [Kb/s] Network capacity from the component system~%uint32[6] link_rx_max # [Kb/s] Network capacity to the component system~%~%~%"))
