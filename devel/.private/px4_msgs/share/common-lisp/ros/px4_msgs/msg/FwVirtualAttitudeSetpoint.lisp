...
;//! \htmlinclude FwVirtualAttitudeSetpoint.msg.html

(cl:defclass <FwVirtualAttitudeSetpoint> (roslisp-msg-protocol:ros-message)
  ((timestamp
    :reader timestamp
    :initarg :timestamp
    :type cl:integer
...
(cl:defclass FwVirtualAttitudeSetpoint (<FwVirtualAttitudeSetpoint>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <FwVirtualAttitudeSetpoint>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'FwVirtualAttitudeSetpoint)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name px4_msgs-msg:<FwVirtualAttitudeSetpoint> is deprecated: use px4_msgs-msg:FwVirtualAttitudeSetpoint instead.")))

(cl:ensure-generic-function 'timestamp-val :lambda-list '(m))
(cl:defmethod timestamp-val ((m <FwVirtualAttitudeSetpoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader px4_msgs-msg:timestamp-val is deprecated.  Use px4_msgs-msg:timestamp instead.")
  (timestamp m))

(cl:ensure-generic-function 'roll_body-val :lambda-list '(m))
(cl:defmethod roll_body-val ((m <FwVirtualAttitudeSetpoint>))
...
(cl:defmethod pitch_body-val ((m <FwVirtualAttitudeSetpoint>))
...
(cl:defmethod yaw_body-val ((m <FwVirtualAttitudeSetpoint>))
...
(cl:defmethod yaw_sp_move_rate-val ((m <FwVirtualAttitudeSetpoint>))
...
(cl:defmethod q_d-val ((m <FwVirtualAttitudeSetpoint>))
...
(cl:defmethod thrust_body-val ((m <FwVirtualAttitudeSetpoint>))
...
(cl:defmethod roll_reset_integral-val ((m <FwVirtualAttitudeSetpoint>))
...
(cl:defmethod pitch_reset_integral-val ((m <FwVirtualAttitudeSetpoint>))
...
(cl:defmethod yaw_reset_integral-val ((m <FwVirtualAttitudeSetpoint>))
...
(cl:defmethod fw_control_yaw-val ((m <FwVirtualAttitudeSetpoint>))
...
(cl:defmethod apply_flaps-val ((m <FwVirtualAttitudeSetpoint>))
  ...
  (apply_flaps m))
(cl:defmethod roslisp-msg-protocol:symbol-codes ((msg-type (cl:eql '<FwVirtualAttitudeSetpoint>)))
    "Constants for message type '<FwVirtualAttitudeSetpoint>"
  '((:FLAPS_OFF . 0)
    (:FLAPS_LAND . 1)
    (:FLAPS_TAKEOFF . 2))
)
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <FwVirtualAttitudeSetpoint>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <FwVirtualAttitudeSetpoint>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<FwVirtualAttitudeSetpoint>)))
  "Returns string type for a message object of type '<FwVirtualAttitudeSetpoint>"
  "px4_msgs/FwVirtualAttitudeSetpoint")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'FwVirtualAttitudeSetpoint)))
  "Returns string type for a message object of type 'FwVirtualAttitudeSetpoint"
  "px4_msgs/FwVirtualAttitudeSetpoint")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<FwVirtualAttitudeSetpoint>)))
  "Returns md5sum for a message object of type '<FwVirtualAttitudeSetpoint>"
  "9057af4eb84b2f96111c8fd4c7522575")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'FwVirtualAttitudeSetpoint)))
  "Returns md5sum for a message object of type 'FwVirtualAttitudeSetpoint"
  "9057af4eb84b2f96111c8fd4c7522575")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<FwVirtualAttitudeSetpoint>)))
  "Returns full string definition for message of type '<FwVirtualAttitudeSetpoint>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'FwVirtualAttitudeSetpoint)))
  "Returns full string definition for message of type 'FwVirtualAttitudeSetpoint"
  (cl:format cl:nil "uint64 timestamp		# time since system start (microseconds)~%~%float32 roll_body		# body angle in NED frame (can be NaN for FW)~%float32 pitch_body		# body angle in NED frame (can be NaN for FW)~%float32 yaw_body		# body angle in NED frame (can be NaN for FW)~%~%float32 yaw_sp_move_rate	# rad/s (commanded by user)~%~%# For quaternion-based attitude control~%float32[4] q_d			# Desired quaternion for quaternion control~%~%# For clarification: For multicopters thrust_body[0] and thrust[1] are usually 0 and thrust[2] is the negative throttle demand.~%# For fixed wings thrust_x is the throttle demand and thrust_y, thrust_z will usually be zero.~%float32[3] thrust_body		# Normalized thrust command in body NED frame [-1,1]~%~%bool roll_reset_integral	# Reset roll integral part (navigation logic change)~%bool pitch_reset_integral	# Reset pitch integral part (navigation logic change)~%bool yaw_reset_integral	# Reset yaw integral part (navigation logic change)~%~%bool fw_control_yaw		# control heading with rudder (used for auto takeoff on runway)~%~%uint8 apply_flaps       	# flap config specifier~%uint8 FLAPS_OFF = 0     	# no flaps~%uint8 FLAPS_LAND = 1    	# landing config flaps~%uint8 FLAPS_TAKEOFF = 2 	# take-off config flaps~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <FwVirtualAttitudeSetpoint>))
  (cl:+ 0
     8
     4
     4
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <FwVirtualAttitudeSetpoint>))
  "Converts a ROS message object to a list"
  (cl:list 'FwVirtualAttitudeSetpoint
