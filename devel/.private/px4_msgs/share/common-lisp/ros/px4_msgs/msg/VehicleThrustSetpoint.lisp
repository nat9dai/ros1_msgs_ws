...
;//! \htmlinclude VehicleThrustSetpoint.msg.html

(cl:defclass <VehicleThrustSetpoint> (roslisp-msg-protocol:ros-message)
  ((timestamp
    :reader timestamp
    :initarg :timestamp
    :type cl:integer
...
(cl:defclass VehicleThrustSetpoint (<VehicleThrustSetpoint>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <VehicleThrustSetpoint>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'VehicleThrustSetpoint)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name px4_msgs-msg:<VehicleThrustSetpoint> is deprecated: use px4_msgs-msg:VehicleThrustSetpoint instead.")))

(cl:ensure-generic-function 'timestamp-val :lambda-list '(m))
(cl:defmethod timestamp-val ((m <VehicleThrustSetpoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader px4_msgs-msg:timestamp-val is deprecated.  Use px4_msgs-msg:timestamp instead.")
  (timestamp m))

(cl:ensure-generic-function 'timestamp_sample-val :lambda-list '(m))
(cl:defmethod timestamp_sample-val ((m <VehicleThrustSetpoint>))
...
(cl:defmethod xyz-val ((m <VehicleThrustSetpoint>))
  ...
  (xyz m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <VehicleThrustSetpoint>) ostream)
  "Serializes a message object of type '<VehicleThrustSetpoint>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <VehicleThrustSetpoint>) istream)
  "Deserializes a message object of type '<VehicleThrustSetpoint>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<VehicleThrustSetpoint>)))
  "Returns string type for a message object of type '<VehicleThrustSetpoint>"
  "px4_msgs/VehicleThrustSetpoint")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'VehicleThrustSetpoint)))
  "Returns string type for a message object of type 'VehicleThrustSetpoint"
  "px4_msgs/VehicleThrustSetpoint")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<VehicleThrustSetpoint>)))
  "Returns md5sum for a message object of type '<VehicleThrustSetpoint>"
  "88b7d1ed56fc632d088f26d07cc23fe6")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'VehicleThrustSetpoint)))
  "Returns md5sum for a message object of type 'VehicleThrustSetpoint"
  "88b7d1ed56fc632d088f26d07cc23fe6")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<VehicleThrustSetpoint>)))
  "Returns full string definition for message of type '<VehicleThrustSetpoint>"
  (cl:format cl:nil "~%uint64 timestamp        # time since system start (microseconds)~%uint64 timestamp_sample # timestamp of the data sample on which this message is based (microseconds)~%~%float32[3] xyz          # thrust setpoint along X, Y, Z body axis (in N)~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'VehicleThrustSetpoint)))
  "Returns full string definition for message of type 'VehicleThrustSetpoint"
  (cl:format cl:nil "~%uint64 timestamp        # time since system start (microseconds)~%uint64 timestamp_sample # timestamp of the data sample on which this message is based (microseconds)~%~%float32[3] xyz          # thrust setpoint along X, Y, Z body axis (in N)~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <VehicleThrustSetpoint>))
  (cl:+ 0
     8
     8
     0 (cl:reduce #'cl:+ (cl:slot-value msg 'xyz) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ 4)))
))
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <VehicleThrustSetpoint>))
  "Converts a ROS message object to a list"
  (cl:list 'VehicleThrustSetpoint
