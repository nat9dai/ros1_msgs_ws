...
;//! \htmlinclude ActuatorControls0.msg.html

(cl:defclass <ActuatorControls0> (roslisp-msg-protocol:ros-message)
  ((timestamp
    :reader timestamp
    :initarg :timestamp
    :type cl:integer
...
(cl:defclass ActuatorControls0 (<ActuatorControls0>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <ActuatorControls0>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'ActuatorControls0)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name px4_msgs-msg:<ActuatorControls0> is deprecated: use px4_msgs-msg:ActuatorControls0 instead.")))

(cl:ensure-generic-function 'timestamp-val :lambda-list '(m))
(cl:defmethod timestamp-val ((m <ActuatorControls0>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader px4_msgs-msg:timestamp-val is deprecated.  Use px4_msgs-msg:timestamp instead.")
  (timestamp m))

(cl:ensure-generic-function 'timestamp_sample-val :lambda-list '(m))
(cl:defmethod timestamp_sample-val ((m <ActuatorControls0>))
...
(cl:defmethod control-val ((m <ActuatorControls0>))
  ...
  (control m))
(cl:defmethod roslisp-msg-protocol:symbol-codes ((msg-type (cl:eql '<ActuatorControls0>)))
    "Constants for message type '<ActuatorControls0>"
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <ActuatorControls0>) ostream)
  "Serializes a message object of type '<ActuatorControls0>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ActuatorControls0>) istream)
  "Deserializes a message object of type '<ActuatorControls0>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ActuatorControls0>)))
  "Returns string type for a message object of type '<ActuatorControls0>"
  "px4_msgs/ActuatorControls0")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ActuatorControls0)))
  "Returns string type for a message object of type 'ActuatorControls0"
  "px4_msgs/ActuatorControls0")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ActuatorControls0>)))
  "Returns md5sum for a message object of type '<ActuatorControls0>"
  "b2e727b373981b888a45a87c1771aca3")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ActuatorControls0)))
  "Returns md5sum for a message object of type 'ActuatorControls0"
  "b2e727b373981b888a45a87c1771aca3")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ActuatorControls0>)))
  "Returns full string definition for message of type '<ActuatorControls0>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ActuatorControls0)))
  "Returns full string definition for message of type 'ActuatorControls0"
  (cl:format cl:nil "uint64 timestamp			# time since system start (microseconds)~%uint8 NUM_ACTUATOR_CONTROLS = 8~%uint8 NUM_ACTUATOR_CONTROL_GROUPS = 6~%uint8 INDEX_ROLL = 0~%uint8 INDEX_PITCH = 1~%uint8 INDEX_YAW = 2~%uint8 INDEX_THROTTLE = 3~%uint8 INDEX_FLAPS = 4~%uint8 INDEX_SPOILERS = 5~%uint8 INDEX_AIRBRAKES = 6~%uint8 INDEX_LANDING_GEAR = 7~%uint8 INDEX_GIMBAL_SHUTTER = 3~%uint8 INDEX_CAMERA_ZOOM = 4~%~%uint8 GROUP_INDEX_ATTITUDE = 0~%uint8 GROUP_INDEX_ATTITUDE_ALTERNATE = 1~%uint8 GROUP_INDEX_GIMBAL = 2~%uint8 GROUP_INDEX_MANUAL_PASSTHROUGH = 3~%uint8 GROUP_INDEX_ALLOCATED_PART1 = 4~%uint8 GROUP_INDEX_ALLOCATED_PART2 = 5~%uint8 GROUP_INDEX_PAYLOAD = 6~%~%uint64 timestamp_sample	    # the timestamp the data this control response is based on was sampled~%float32[8] control~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <ActuatorControls0>))
  (cl:+ 0
     8
     8
     0 (cl:reduce #'cl:+ (cl:slot-value msg 'control) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ 4)))
))
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <ActuatorControls0>))
  "Converts a ROS message object to a list"
  (cl:list 'ActuatorControls0
