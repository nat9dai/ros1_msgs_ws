...
;//! \htmlinclude VehicleTrajectoryWaypoint.msg.html

(cl:defclass <VehicleTrajectoryWaypoint> (roslisp-msg-protocol:ros-message)
  ((timestamp
    :reader timestamp
    :initarg :timestamp
    :type cl:integer
...
(cl:defclass VehicleTrajectoryWaypoint (<VehicleTrajectoryWaypoint>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <VehicleTrajectoryWaypoint>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'VehicleTrajectoryWaypoint)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name px4_msgs-msg:<VehicleTrajectoryWaypoint> is deprecated: use px4_msgs-msg:VehicleTrajectoryWaypoint instead.")))

(cl:ensure-generic-function 'timestamp-val :lambda-list '(m))
(cl:defmethod timestamp-val ((m <VehicleTrajectoryWaypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader px4_msgs-msg:timestamp-val is deprecated.  Use px4_msgs-msg:timestamp instead.")
  (timestamp m))

(cl:ensure-generic-function 'type-val :lambda-list '(m))
(cl:defmethod type-val ((m <VehicleTrajectoryWaypoint>))
...
(cl:defmethod waypoints-val ((m <VehicleTrajectoryWaypoint>))
  ...
  (waypoints m))
(cl:defmethod roslisp-msg-protocol:symbol-codes ((msg-type (cl:eql '<VehicleTrajectoryWaypoint>)))
    "Constants for message type '<VehicleTrajectoryWaypoint>"
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <VehicleTrajectoryWaypoint>) ostream)
  "Serializes a message object of type '<VehicleTrajectoryWaypoint>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <VehicleTrajectoryWaypoint>) istream)
  "Deserializes a message object of type '<VehicleTrajectoryWaypoint>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<VehicleTrajectoryWaypoint>)))
  "Returns string type for a message object of type '<VehicleTrajectoryWaypoint>"
  "px4_msgs/VehicleTrajectoryWaypoint")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'VehicleTrajectoryWaypoint)))
  "Returns string type for a message object of type 'VehicleTrajectoryWaypoint"
  "px4_msgs/VehicleTrajectoryWaypoint")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<VehicleTrajectoryWaypoint>)))
  "Returns md5sum for a message object of type '<VehicleTrajectoryWaypoint>"
  "47555c3c4cb2c662f1fc75a4cc3856ae")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'VehicleTrajectoryWaypoint)))
  "Returns md5sum for a message object of type 'VehicleTrajectoryWaypoint"
  "47555c3c4cb2c662f1fc75a4cc3856ae")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<VehicleTrajectoryWaypoint>)))
  "Returns full string definition for message of type '<VehicleTrajectoryWaypoint>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'VehicleTrajectoryWaypoint)))
  "Returns full string definition for message of type 'VehicleTrajectoryWaypoint"
  (cl:format cl:nil "# Vehicle Waypoints Trajectory description. See also MAVLink MAV_TRAJECTORY_REPRESENTATION msg~%# The topic vehicle_trajectory_waypoint_desired is used to send the user desired waypoints from the position controller to the companion computer / avoidance module.~%# The topic vehicle_trajectory_waypoint is used to send the adjusted waypoints from the companion computer / avoidance module to the position controller.~%~%uint64 timestamp		# time since system start (microseconds)~%~%uint8 MAV_TRAJECTORY_REPRESENTATION_WAYPOINTS = 0~%~%uint8 type # Type from MAV_TRAJECTORY_REPRESENTATION enum.~%~%uint8 POINT_0 = 0~%uint8 POINT_1 = 1~%uint8 POINT_2 = 2~%uint8 POINT_3 = 3~%uint8 POINT_4 = 4~%~%uint8 NUMBER_POINTS = 5~%~%TrajectoryWaypoint[5] waypoints~%~%~%================================================================================~%MSG: px4_msgs/TrajectoryWaypoint~%# Waypoint Trajectory description. See also Mavlink TRAJECTORY msg~%# The topic trajectory_waypoint describe each waypoint defined in vehicle_trajectory_waypoint~%~%uint64 timestamp		# time since system start (microseconds)~%~%float32[3] position~%float32[3] velocity~%float32[3] acceleration~%float32 yaw~%float32 yaw_speed~%~%bool point_valid~%uint8 type~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <VehicleTrajectoryWaypoint>))
  (cl:+ 0
     8
     1
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <VehicleTrajectoryWaypoint>))
  "Converts a ROS message object to a list"
  (cl:list 'VehicleTrajectoryWaypoint
