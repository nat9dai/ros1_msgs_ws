...
;//! \htmlinclude TrajectorySetpoint.msg.html

(cl:defclass <TrajectorySetpoint> (roslisp-msg-protocol:ros-message)
  ((timestamp
    :reader timestamp
    :initarg :timestamp
    :type cl:integer
...
(cl:defclass TrajectorySetpoint (<TrajectorySetpoint>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <TrajectorySetpoint>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'TrajectorySetpoint)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name px4_msgs-msg:<TrajectorySetpoint> is deprecated: use px4_msgs-msg:TrajectorySetpoint instead.")))

(cl:ensure-generic-function 'timestamp-val :lambda-list '(m))
(cl:defmethod timestamp-val ((m <TrajectorySetpoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader px4_msgs-msg:timestamp-val is deprecated.  Use px4_msgs-msg:timestamp instead.")
  (timestamp m))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <TrajectorySetpoint>))
...
(cl:defmethod y-val ((m <TrajectorySetpoint>))
...
(cl:defmethod z-val ((m <TrajectorySetpoint>))
...
(cl:defmethod yaw-val ((m <TrajectorySetpoint>))
...
(cl:defmethod yawspeed-val ((m <TrajectorySetpoint>))
...
(cl:defmethod vx-val ((m <TrajectorySetpoint>))
...
(cl:defmethod vy-val ((m <TrajectorySetpoint>))
...
(cl:defmethod vz-val ((m <TrajectorySetpoint>))
...
(cl:defmethod acceleration-val ((m <TrajectorySetpoint>))
...
(cl:defmethod jerk-val ((m <TrajectorySetpoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader px4_msgs-msg:jerk-val is deprecated.  Use px4_msgs-msg:jerk instead.")
  (jerk m))

(cl:ensure-generic-function 'thrust-val :lambda-list '(m))
(cl:defmethod thrust-val ((m <TrajectorySetpoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader px4_msgs-msg:thrust-val is deprecated.  Use px4_msgs-msg:thrust instead.")
  (thrust m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <TrajectorySetpoint>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <TrajectorySetpoint>) istream)
  ...
  (cl:setf (cl:slot-value msg 'jerk) (cl:make-array 3))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<TrajectorySetpoint>)))
  "Returns string type for a message object of type '<TrajectorySetpoint>"
  "px4_msgs/TrajectorySetpoint")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TrajectorySetpoint)))
  "Returns string type for a message object of type 'TrajectorySetpoint"
  "px4_msgs/TrajectorySetpoint")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<TrajectorySetpoint>)))
  "Returns md5sum for a message object of type '<TrajectorySetpoint>"
  "ebf2f4e0a73d13edd853fd0869b5471a")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'TrajectorySetpoint)))
  "Returns md5sum for a message object of type 'TrajectorySetpoint"
  "ebf2f4e0a73d13edd853fd0869b5471a")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<TrajectorySetpoint>)))
  "Returns full string definition for message of type '<TrajectorySetpoint>"
  (cl:format cl:nil "# Local position setpoint in NED frame~%# setting something to NaN means the state should not be controlled~%~%uint64 timestamp	# time since system start (microseconds)~%~%float32 x		# in meters NED~%float32 y		# in meters NED~%float32 z		# in meters NED~%float32 yaw		# in radians NED -PI..+PI~%float32 yawspeed	# in radians/sec~%float32 vx		# in meters/sec~%float32 vy		# in meters/sec~%float32 vz		# in meters/sec~%float32[3] acceleration # in meters/sec^2~%float32[3] jerk # in meters/sec^3~%float32[3] thrust	# normalized thrust vector in NED~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'TrajectorySetpoint)))
  "Returns full string definition for message of type 'TrajectorySetpoint"
  (cl:format cl:nil "# Local position setpoint in NED frame~%# setting something to NaN means the state should not be controlled~%~%uint64 timestamp	# time since system start (microseconds)~%~%float32 x		# in meters NED~%float32 y		# in meters NED~%float32 z		# in meters NED~%float32 yaw		# in radians NED -PI..+PI~%float32 yawspeed	# in radians/sec~%float32 vx		# in meters/sec~%float32 vy		# in meters/sec~%float32 vz		# in meters/sec~%float32[3] acceleration # in meters/sec^2~%float32[3] jerk # in meters/sec^3~%float32[3] thrust	# normalized thrust vector in NED~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <TrajectorySetpoint>))
  (cl:+ 0
     8
     4
     4
     ...
     0 (cl:reduce #'cl:+ (cl:slot-value msg 'jerk) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ 4)))
     0 (cl:reduce #'cl:+ (cl:slot-value msg 'thrust) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ 4)))
))
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <TrajectorySetpoint>))
  "Converts a ROS message object to a list"
  (cl:list 'TrajectorySetpoint
