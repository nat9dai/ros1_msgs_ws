...
class ActuatorControls0 {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ActuatorControls0(null);
  ...
  static datatype() {
    ...
    return 'px4_msgs/ActuatorControls0';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ActuatorControls0(null);
...
module.exports = ActuatorControls0;
