...
class VehicleAttitudeGroundtruth {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new VehicleAttitudeGroundtruth(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new VehicleAttitudeGroundtruth(null);
...
module.exports = VehicleAttitudeGroundtruth;
