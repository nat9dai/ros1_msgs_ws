...
class VehicleTorqueSetpoint {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new VehicleTorqueSetpoint(null);
  ...
  static datatype() {
    ...
    return 'px4_msgs/VehicleTorqueSetpoint';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new VehicleTorqueSetpoint(null);
...
module.exports = VehicleTorqueSetpoint;
