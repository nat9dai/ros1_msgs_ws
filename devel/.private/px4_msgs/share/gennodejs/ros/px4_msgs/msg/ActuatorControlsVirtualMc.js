...
class ActuatorControlsVirtualMc {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ActuatorControlsVirtualMc(null);
  ...
  static datatype() {
    ...
    return 'px4_msgs/ActuatorControlsVirtualMc';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ActuatorControlsVirtualMc(null);
...
ActuatorControlsVirtualMc.Constants = {
...
module.exports = ActuatorControlsVirtualMc;
