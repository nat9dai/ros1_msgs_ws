...
class VehicleTrajectoryWaypoint {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new VehicleTrajectoryWaypoint(null);
  ...
  static datatype() {
    ...
    return 'px4_msgs/VehicleTrajectoryWaypoint';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new VehicleTrajectoryWaypoint(null);
...
VehicleTrajectoryWaypoint.Constants = {
...
module.exports = VehicleTrajectoryWaypoint;
