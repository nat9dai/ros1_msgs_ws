...
class CameraTriggerSecondary {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new CameraTriggerSecondary(null);
  ...
  static datatype() {
    ...
    return 'px4_msgs/CameraTriggerSecondary';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new CameraTriggerSecondary(null);
...
module.exports = CameraTriggerSecondary;
