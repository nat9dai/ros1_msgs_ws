...
class EstimatorGlobalPosition {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new EstimatorGlobalPosition(null);
  ...
  static datatype() {
    ...
    return 'px4_msgs/EstimatorGlobalPosition';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new EstimatorGlobalPosition(null);
...
module.exports = EstimatorGlobalPosition;
