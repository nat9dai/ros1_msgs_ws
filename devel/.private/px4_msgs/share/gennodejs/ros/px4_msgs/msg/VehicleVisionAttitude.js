...
class VehicleVisionAttitude {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new VehicleVisionAttitude(null);
  ...
  static datatype() {
    ...
    return 'px4_msgs/VehicleVisionAttitude';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new VehicleVisionAttitude(null);
...
module.exports = VehicleVisionAttitude;
