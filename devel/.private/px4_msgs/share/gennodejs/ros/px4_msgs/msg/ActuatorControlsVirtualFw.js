...
class ActuatorControlsVirtualFw {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ActuatorControlsVirtualFw(null);
  ...
  static datatype() {
    ...
    return 'px4_msgs/ActuatorControlsVirtualFw';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ActuatorControlsVirtualFw(null);
...
ActuatorControlsVirtualFw.Constants = {
...
module.exports = ActuatorControlsVirtualFw;
