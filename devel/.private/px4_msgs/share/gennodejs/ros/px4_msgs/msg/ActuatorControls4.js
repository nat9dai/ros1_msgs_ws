...
class ActuatorControls4 {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ActuatorControls4(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new ActuatorControls4(null);
...
module.exports = ActuatorControls4;
