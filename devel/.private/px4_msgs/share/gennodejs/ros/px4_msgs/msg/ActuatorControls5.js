...
class ActuatorControls5 {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ActuatorControls5(null);
  ...
  static datatype() {
    ...
    return 'px4_msgs/ActuatorControls5';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ActuatorControls5(null);
...
module.exports = ActuatorControls5;
