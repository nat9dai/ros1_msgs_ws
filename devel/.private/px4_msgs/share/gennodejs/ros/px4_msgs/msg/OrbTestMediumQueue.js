...
class OrbTestMediumQueue {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new OrbTestMediumQueue(null);
  ...
  static datatype() {
    ...
    return 'px4_msgs/OrbTestMediumQueue';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new OrbTestMediumQueue(null);
...
module.exports = OrbTestMediumQueue;
