...
class VehicleAttitudeSetpoint {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new VehicleAttitudeSetpoint(null);
  ...
  static datatype() {
    ...
    return 'px4_msgs/VehicleAttitudeSetpoint';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new VehicleAttitudeSetpoint(null);
...
VehicleAttitudeSetpoint.Constants = {
  FLAPS_OFF: 0,
  FLAPS_LAND: 1,
  FLAPS_TAKEOFF: 2,
}

module.exports = VehicleAttitudeSetpoint;
