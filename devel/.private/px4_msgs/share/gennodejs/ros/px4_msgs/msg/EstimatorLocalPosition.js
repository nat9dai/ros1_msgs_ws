...
class EstimatorLocalPosition {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new EstimatorLocalPosition(null);
  ...
  static datatype() {
    ...
    return 'px4_msgs/EstimatorLocalPosition';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new EstimatorLocalPosition(null);
