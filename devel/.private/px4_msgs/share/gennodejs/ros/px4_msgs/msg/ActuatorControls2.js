...
class ActuatorControls2 {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ActuatorControls2(null);
  ...
  static datatype() {
    ...
    return 'px4_msgs/ActuatorControls2';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ActuatorControls2(null);
...
module.exports = ActuatorControls2;
