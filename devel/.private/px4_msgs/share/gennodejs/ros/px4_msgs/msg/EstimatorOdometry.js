...
class EstimatorOdometry {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new EstimatorOdometry(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new EstimatorOdometry(null);
...
module.exports = EstimatorOdometry;
