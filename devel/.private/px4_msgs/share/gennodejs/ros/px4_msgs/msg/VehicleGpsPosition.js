...
class VehicleGpsPosition {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.uint8(obj.selected, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new VehicleGpsPosition(null);
    ...
    data.selected = _deserializer.uint8(buffer, bufferOffset);
    return data;
  }
  ...
  static datatype() {
    ...
    return 'px4_msgs/VehicleGpsPosition';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '6c59a68c08a0ef8db2f27b325ff654dc';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new VehicleGpsPosition(null);
...
module.exports = VehicleGpsPosition;
