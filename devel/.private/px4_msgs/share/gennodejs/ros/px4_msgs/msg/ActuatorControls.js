...
class ActuatorControls {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ActuatorControls(null);
  ...
  static datatype() {
    ...
    return 'px4_msgs/ActuatorControls';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ActuatorControls(null);
...
module.exports = ActuatorControls;
