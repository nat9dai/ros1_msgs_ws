...
class AirspeedWind {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('tas_scale')) {
        this.tas_scale = initObj.tas_scale
      }
      else {
        this.tas_scale = 0.0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [tas_scale]
    bufferOffset = _serializer.float32(obj.tas_scale, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new AirspeedWind(null);
    ...
    // Deserialize message field [tas_scale]
    data.tas_scale = _deserializer.float32(buffer, bufferOffset);
  ...
  static datatype() {
    ...
    return 'px4_msgs/AirspeedWind';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return 'c1501e37b2acd6f5d6a2ec8888b4c11f';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new AirspeedWind(null);
    ...
    if (msg.tas_scale !== undefined) {
      resolved.tas_scale = msg.tas_scale;
    }
    else {
      resolved.tas_scale = 0.0
    }
