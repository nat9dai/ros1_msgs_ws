...
class VehicleLocalPosition {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new VehicleLocalPosition(null);
  ...
  static datatype() {
    ...
    return 'px4_msgs/VehicleLocalPosition';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new VehicleLocalPosition(null);
