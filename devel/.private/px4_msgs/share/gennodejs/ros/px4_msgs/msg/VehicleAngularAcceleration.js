...
class VehicleAngularAcceleration {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new VehicleAngularAcceleration(null);
  ...
  static datatype() {
    ...
    return 'px4_msgs/VehicleAngularAcceleration';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new VehicleAngularAcceleration(null);
...
module.exports = VehicleAngularAcceleration;
