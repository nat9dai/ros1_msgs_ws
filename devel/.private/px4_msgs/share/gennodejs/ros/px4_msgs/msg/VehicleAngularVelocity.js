...
class VehicleAngularVelocity {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new VehicleAngularVelocity(null);
  ...
  static datatype() {
    ...
    return 'px4_msgs/VehicleAngularVelocity';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new VehicleAngularVelocity(null);
...
module.exports = VehicleAngularVelocity;
