...
class EstimatorInnovationTestRatios {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new EstimatorInnovationTestRatios(null);
  ...
  static datatype() {
    ...
    return 'px4_msgs/EstimatorInnovationTestRatios';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new EstimatorInnovationTestRatios(null);
...
module.exports = EstimatorInnovationTestRatios;
