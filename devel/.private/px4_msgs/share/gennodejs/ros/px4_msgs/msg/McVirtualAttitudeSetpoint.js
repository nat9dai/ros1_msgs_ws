...
class McVirtualAttitudeSetpoint {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new McVirtualAttitudeSetpoint(null);
  ...
  static datatype() {
    ...
    return 'px4_msgs/McVirtualAttitudeSetpoint';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new McVirtualAttitudeSetpoint(null);
...
McVirtualAttitudeSetpoint.Constants = {
  FLAPS_OFF: 0,
  FLAPS_LAND: 1,
  FLAPS_TAKEOFF: 2,
}

module.exports = McVirtualAttitudeSetpoint;
