...
class EstimatorInnovationVariances {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new EstimatorInnovationVariances(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new EstimatorInnovationVariances(null);
...
module.exports = EstimatorInnovationVariances;
