...
class VehicleMocapOdometry {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new VehicleMocapOdometry(null);
  ...
  static datatype() {
    ...
    return 'px4_msgs/VehicleMocapOdometry';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new VehicleMocapOdometry(null);
...
VehicleMocapOdometry.Constants = {
...
module.exports = VehicleMocapOdometry;
