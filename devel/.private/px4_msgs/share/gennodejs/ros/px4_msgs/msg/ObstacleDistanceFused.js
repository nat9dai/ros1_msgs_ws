...
class ObstacleDistanceFused {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ObstacleDistanceFused(null);
  ...
  static datatype() {
    ...
    return 'px4_msgs/ObstacleDistanceFused';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ObstacleDistanceFused(null);
...
ObstacleDistanceFused.Constants = {
  MAV_FRAME_GLOBAL: 0,
...
module.exports = ObstacleDistanceFused;
