...
class ActuatorControls3 {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ActuatorControls3(null);
  ...
  static datatype() {
    ...
    return 'px4_msgs/ActuatorControls3';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ActuatorControls3(null);
...
module.exports = ActuatorControls3;
