...
class VehicleVisualOdometry {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new VehicleVisualOdometry(null);
  ...
  static datatype() {
    ...
    return 'px4_msgs/VehicleVisualOdometry';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new VehicleVisualOdometry(null);
...
VehicleVisualOdometry.Constants = {
...
module.exports = VehicleVisualOdometry;
