...
class VehicleLocalPositionSetpoint {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type VehicleLocalPositionSetpoint
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type VehicleLocalPositionSetpoint
    let len;
    let data = new VehicleLocalPositionSetpoint(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new VehicleLocalPositionSetpoint(null);
...
module.exports = VehicleLocalPositionSetpoint;
