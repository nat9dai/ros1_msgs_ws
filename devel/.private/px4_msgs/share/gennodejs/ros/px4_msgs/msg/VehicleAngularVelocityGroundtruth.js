...
class VehicleAngularVelocityGroundtruth {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new VehicleAngularVelocityGroundtruth(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new VehicleAngularVelocityGroundtruth(null);
...
module.exports = VehicleAngularVelocityGroundtruth;
