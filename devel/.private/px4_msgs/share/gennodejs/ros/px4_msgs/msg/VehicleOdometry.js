...
class VehicleOdometry {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new VehicleOdometry(null);
  ...
  static datatype() {
    ...
    return 'px4_msgs/VehicleOdometry';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new VehicleOdometry(null);
...
module.exports = VehicleOdometry;
