// Generated by gencpp from file px4_msgs/GimbalDeviceSetAttitude.msg
// DO NOT EDIT!


#ifndef PX4_MSGS_MESSAGE_GIMBALDEVICESETATTITUDE_H
#define PX4_MSGS_MESSAGE_GIMBALDEVICESETATTITUDE_H
...
// reducing the odds to have name collisions with Windows.h 
  ...
  typedef boost::shared_ptr< ::px4_msgs::GimbalDeviceSetAttitude_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::px4_msgs::GimbalDeviceSetAttitude_<ContainerAllocator> const> ConstPtr;

}; // struct GimbalDeviceSetAttitude_

typedef ::px4_msgs::GimbalDeviceSetAttitude_<std::allocator<void> > GimbalDeviceSetAttitude;

typedef boost::shared_ptr< ::px4_msgs::GimbalDeviceSetAttitude > GimbalDeviceSetAttitudePtr;
typedef boost::shared_ptr< ::px4_msgs::GimbalDeviceSetAttitude const> GimbalDeviceSetAttitudeConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::px4_msgs::GimbalDeviceSetAttitude_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::px4_msgs::GimbalDeviceSetAttitude_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::px4_msgs::GimbalDeviceSetAttitude_<ContainerAllocator1> & lhs, const ::px4_msgs::GimbalDeviceSetAttitude_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::px4_msgs::GimbalDeviceSetAttitude_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::px4_msgs::GimbalDeviceSetAttitude_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::px4_msgs::GimbalDeviceSetAttitude_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::px4_msgs::GimbalDeviceSetAttitude_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::px4_msgs::GimbalDeviceSetAttitude_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::px4_msgs::GimbalDeviceSetAttitude_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::px4_msgs::GimbalDeviceSetAttitude_<ContainerAllocator> >
{
  ...
  static const char* value(const ::px4_msgs::GimbalDeviceSetAttitude_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xeee7348fa08948c1ULL;
  static const uint64_t static_value2 = 0xdd27a080d2f65da8ULL;
};

template<class ContainerAllocator>
struct DataType< ::px4_msgs::GimbalDeviceSetAttitude_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::px4_msgs::GimbalDeviceSetAttitude_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::px4_msgs::GimbalDeviceSetAttitude_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::px4_msgs::GimbalDeviceSetAttitude_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::px4_msgs::GimbalDeviceSetAttitude_<ContainerAllocator>& v)
  {
...
#endif // PX4_MSGS_MESSAGE_GIMBALDEVICESETATTITUDE_H
