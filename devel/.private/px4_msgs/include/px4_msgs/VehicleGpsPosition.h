// Generated by gencpp from file px4_msgs/VehicleGpsPosition.msg
// DO NOT EDIT!


#ifndef PX4_MSGS_MESSAGE_VEHICLEGPSPOSITION_H
#define PX4_MSGS_MESSAGE_VEHICLEGPSPOSITION_H
...
{
  typedef VehicleGpsPosition_<ContainerAllocator> Type;
  ...
  VehicleGpsPosition_(const ContainerAllocator& _alloc)
    : timestamp(0)
    , lat(0)
    , lon(0)
    , alt(0)
  ...
  typedef boost::shared_ptr< ::px4_msgs::VehicleGpsPosition_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::px4_msgs::VehicleGpsPosition_<ContainerAllocator> const> ConstPtr;

}; // struct VehicleGpsPosition_

typedef ::px4_msgs::VehicleGpsPosition_<std::allocator<void> > VehicleGpsPosition;

typedef boost::shared_ptr< ::px4_msgs::VehicleGpsPosition > VehicleGpsPositionPtr;
typedef boost::shared_ptr< ::px4_msgs::VehicleGpsPosition const> VehicleGpsPositionConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::px4_msgs::VehicleGpsPosition_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::px4_msgs::VehicleGpsPosition_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::px4_msgs::VehicleGpsPosition_<ContainerAllocator1> & lhs, const ::px4_msgs::VehicleGpsPosition_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::px4_msgs::VehicleGpsPosition_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::px4_msgs::VehicleGpsPosition_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::px4_msgs::VehicleGpsPosition_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::px4_msgs::VehicleGpsPosition_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::px4_msgs::VehicleGpsPosition_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::px4_msgs::VehicleGpsPosition_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::px4_msgs::VehicleGpsPosition_<ContainerAllocator> >
{
  ...
  static const char* value(const ::px4_msgs::VehicleGpsPosition_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x6c59a68c08a0ef8dULL;
  static const uint64_t static_value2 = 0xb2f27b325ff654dcULL;
};

template<class ContainerAllocator>
struct DataType< ::px4_msgs::VehicleGpsPosition_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::px4_msgs::VehicleGpsPosition_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::px4_msgs::VehicleGpsPosition_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::px4_msgs::VehicleGpsPosition_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::px4_msgs::VehicleGpsPosition_<ContainerAllocator>& v)
  {
...
#endif // PX4_MSGS_MESSAGE_VEHICLEGPSPOSITION_H
