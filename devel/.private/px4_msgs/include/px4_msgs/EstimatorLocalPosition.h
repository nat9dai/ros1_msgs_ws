// Generated by gencpp from file px4_msgs/EstimatorLocalPosition.msg
// DO NOT EDIT!


#ifndef PX4_MSGS_MESSAGE_ESTIMATORLOCALPOSITION_H
#define PX4_MSGS_MESSAGE_ESTIMATORLOCALPOSITION_H
...
{
  typedef EstimatorLocalPosition_<ContainerAllocator> Type;

  EstimatorLocalPosition_()
    : timestamp(0)
    , timestamp_sample(0)
    , xy_valid(false)
    , z_valid(false)
  ...
  EstimatorLocalPosition_(const ContainerAllocator& _alloc)
    : timestamp(0)
    , timestamp_sample(0)
    , xy_valid(false)
    , z_valid(false)
...
// reducing the odds to have name collisions with Windows.h 
  ...
  typedef boost::shared_ptr< ::px4_msgs::EstimatorLocalPosition_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::px4_msgs::EstimatorLocalPosition_<ContainerAllocator> const> ConstPtr;

}; // struct EstimatorLocalPosition_

typedef ::px4_msgs::EstimatorLocalPosition_<std::allocator<void> > EstimatorLocalPosition;

typedef boost::shared_ptr< ::px4_msgs::EstimatorLocalPosition > EstimatorLocalPositionPtr;
typedef boost::shared_ptr< ::px4_msgs::EstimatorLocalPosition const> EstimatorLocalPositionConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::px4_msgs::EstimatorLocalPosition_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::px4_msgs::EstimatorLocalPosition_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::px4_msgs::EstimatorLocalPosition_<ContainerAllocator1> & lhs, const ::px4_msgs::EstimatorLocalPosition_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::px4_msgs::EstimatorLocalPosition_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::px4_msgs::EstimatorLocalPosition_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::px4_msgs::EstimatorLocalPosition_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::px4_msgs::EstimatorLocalPosition_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::px4_msgs::EstimatorLocalPosition_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::px4_msgs::EstimatorLocalPosition_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::px4_msgs::EstimatorLocalPosition_<ContainerAllocator> >
{
  ...
  static const char* value(const ::px4_msgs::EstimatorLocalPosition_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x2f5a75aa56090934ULL;
  static const uint64_t static_value2 = 0x4b194ebbdbb3580aULL;
};

template<class ContainerAllocator>
struct DataType< ::px4_msgs::EstimatorLocalPosition_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::px4_msgs::EstimatorLocalPosition_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::px4_msgs::EstimatorLocalPosition_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::px4_msgs::EstimatorLocalPosition_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::px4_msgs::EstimatorLocalPosition_<ContainerAllocator>& v)
  {
...
#endif // PX4_MSGS_MESSAGE_ESTIMATORLOCALPOSITION_H
