...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ParamSet-request>)))
  ...
  (cl:format cl:nil "# Request set parameter value~%~%# XXX DEPRECATED: replaced by ParamSetV2~%~%string param_id~%mavros_msgs/ParamValue value~%~%================================================================================~%MSG: mavros_msgs/ParamValue~%# Parameter value storage type.~%#~%# Integer and float fields:~%#~%# if integer != 0: it is integer value~%# else if real != 0.0: it is float value~%# else: it is zero.~%~%# XXX DEPRECATED: replaced by rmw_interfaces/ParameterValue~%~%int64 integer~%float64 real~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ParamSet-request)))
  "Returns full string definition for message of type 'ParamSet-request"
  (cl:format cl:nil "# Request set parameter value~%~%# XXX DEPRECATED: replaced by ParamSetV2~%~%string param_id~%mavros_msgs/ParamValue value~%~%================================================================================~%MSG: mavros_msgs/ParamValue~%# Parameter value storage type.~%#~%# Integer and float fields:~%#~%# if integer != 0: it is integer value~%# else if real != 0.0: it is float value~%# else: it is zero.~%~%# XXX DEPRECATED: replaced by rmw_interfaces/ParameterValue~%~%int64 integer~%float64 real~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ParamSet-response>)))
  ...
  (cl:format cl:nil "bool success~%mavros_msgs/ParamValue value~%~%~%================================================================================~%MSG: mavros_msgs/ParamValue~%# Parameter value storage type.~%#~%# Integer and float fields:~%#~%# if integer != 0: it is integer value~%# else if real != 0.0: it is float value~%# else: it is zero.~%~%# XXX DEPRECATED: replaced by rmw_interfaces/ParameterValue~%~%int64 integer~%float64 real~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ParamSet-response)))
  "Returns full string definition for message of type 'ParamSet-response"
  (cl:format cl:nil "bool success~%mavros_msgs/ParamValue value~%~%~%================================================================================~%MSG: mavros_msgs/ParamValue~%# Parameter value storage type.~%#~%# Integer and float fields:~%#~%# if integer != 0: it is integer value~%# else if real != 0.0: it is float value~%# else: it is zero.~%~%# XXX DEPRECATED: replaced by rmw_interfaces/ParameterValue~%~%int64 integer~%float64 real~%~%~%"))
