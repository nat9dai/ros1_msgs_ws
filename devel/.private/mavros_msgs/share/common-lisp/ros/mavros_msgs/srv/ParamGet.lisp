...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ParamGet-request>)))
  ...
  (cl:format cl:nil "# Request parameter from attached device~%~%# XXX DEPRECATED: use ros2 parameters api instead~%~%string param_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ParamGet-request)))
  "Returns full string definition for message of type 'ParamGet-request"
  (cl:format cl:nil "# Request parameter from attached device~%~%# XXX DEPRECATED: use ros2 parameters api instead~%~%string param_id~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ParamGet-response>)))
  ...
  (cl:format cl:nil "bool success~%ParamValue value~%~%~%================================================================================~%MSG: mavros_msgs/ParamValue~%# Parameter value storage type.~%#~%# Integer and float fields:~%#~%# if integer != 0: it is integer value~%# else if real != 0.0: it is float value~%# else: it is zero.~%~%# XXX DEPRECATED: replaced by rmw_interfaces/ParameterValue~%~%int64 integer~%float64 real~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ParamGet-response)))
  "Returns full string definition for message of type 'ParamGet-response"
  (cl:format cl:nil "bool success~%ParamValue value~%~%~%================================================================================~%MSG: mavros_msgs/ParamValue~%# Parameter value storage type.~%#~%# Integer and float fields:~%#~%# if integer != 0: it is integer value~%# else if real != 0.0: it is float value~%# else: it is zero.~%~%# XXX DEPRECATED: replaced by rmw_interfaces/ParameterValue~%~%int64 integer~%float64 real~%~%~%"))
