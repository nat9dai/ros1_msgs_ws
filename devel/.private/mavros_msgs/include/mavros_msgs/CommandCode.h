...
// reducing the odds to have name collisions with Windows.h 
...
#endif
#if defined(_WIN32) && defined(DO_RETURN_PATH_START)
  #undef DO_RETURN_PATH_START
#endif
...
#endif
#if defined(_WIN32) && defined(DO_SET_SAFETY_SWITCH_STATE)
  #undef DO_SET_SAFETY_SWITCH_STATE
#endif
  ...
  #undef DO_WINCH
#endif
#if defined(_WIN32) && defined(EXTERNAL_POSITION_ESTIMATE)
  #undef EXTERNAL_POSITION_ESTIMATE
#endif
...
#endif
#if defined(_WIN32) && defined(SET_STORAGE_USAGE)
  #undef SET_STORAGE_USAGE
#endif
#if defined(_WIN32) && defined(SET_CAMERA_SOURCE)
  #undef SET_CAMERA_SOURCE
#endif
  ...
  enum {
    ...
    DO_SET_SAFETY_SWITCH_STATE = 5300u,
    DO_ADSB_OUT_IDENT = 10001u,
    DO_WINCH = 42600u,
    EXTERNAL_POSITION_ESTIMATE = 43003u,
...
struct MD5Sum< ::mavros_msgs::CommandCode_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0xe40a5a2c265efa71ULL;
  static const uint64_t static_value2 = 0xc1d8f993ddc4ff59ULL;
};
