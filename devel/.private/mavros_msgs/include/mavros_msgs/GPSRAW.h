...
// reducing the odds to have name collisions with Windows.h 
...
#endif
#if defined(_WIN32) && defined(GPS_FIX_TYPE_RTK_FLOAT)
  #undef GPS_FIX_TYPE_RTK_FLOAT
#endif
#if defined(_WIN32) && defined(GPS_FIX_TYPE_RTK_FIXED)
  #undef GPS_FIX_TYPE_RTK_FIXED
#endif
  ...
  enum {
    ...
    GPS_FIX_TYPE_RTK_FLOAT = 5u,
    GPS_FIX_TYPE_RTK_FIXED = 6u,
...
struct MD5Sum< ::mavros_msgs::GPSRAW_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0xf4a26595f56ab930ULL;
  static const uint64_t static_value2 = 0x00555539e605a99aULL;
};
